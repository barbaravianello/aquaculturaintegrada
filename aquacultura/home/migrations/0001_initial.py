# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-13 23:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_image', models.CharField(max_length=3, verbose_name='Identificador do item (1, 2, 3,...)')),
                ('image', models.ImageField(upload_to='portfolio/images', verbose_name='Imagem')),
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery', to='home.Portfolio')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
